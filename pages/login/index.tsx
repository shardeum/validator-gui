...
const Login = () => {
  ...
  return (
    <div className="h-screen w-screen flex center">
      ...
      <aside
        className="w-full h-full grow basis-0 bg-[#3042FB] text-white flex flex-col justify-end items-start"
        style={{
      ...
      >
        <div className="flex flex-col items-center mb-20 ml-20 gap-y-8">
          <span
            className={
              "break-normal max-w-sm font-medium text-xl " + GeistSans.className
            }
          >
            Thank you for helping make Shardeum more decentralized and stable by
            running a node
          </span>
